...
export const PySkillScale = () => {
  ...
  const handleSendMessage = async (
    ...
    if (inputText.trim() !== "") {
      ...
      try {
        // Make the API call
        const response = await axiosInstance.post("/llm/py-skill-scale-llm/", {
          input_param: input,
        });
                  ...
                  primary={
                    <Paper
                      ...
                      sx={{
                        ...
                        backgroundColor:
                          message.sender === "user" ? "#e0e0e0" : "#f9e490", // Light grey for user, light blue for bot
